...
public class stage2 extends JPanel implements ActionListener{
    private ImageIcon wallpaper = new ImageIcon(this.getClass().getResource("nightcene.png"));
    private ImageIcon wallpaper1 = new ImageIcon(this.getClass().getResource("end2.png")); //end bg
    private ImageIcon died = new ImageIcon(this.getClass().getResource("died.png"));
    private ImageIcon nextstagebutton = new ImageIcon(this.getClass().getResource("closebt.png"));
    private ImageIcon closebutton = new ImageIcon(this.getClass().getResource("closebt.png")); 
    Hanuman hc = new Hanuman(2);
    stair1 stair1 = new stair1(2);
    stair2 stair2 = new stair2(2);
    stairlong stairlong = new stairlong(1);
    trephet lever = new trephet(2);
    trephet lever2 = new trephet(22);
    door door = new door(2);
    stone1 stone1 = new stone1(1); 
    stone1 stonesmall1 = new stone1(2); 
    stone1 stonesmall2 = new stone1(3); 
    Sahatsakuman2 MB1 = new Sahatsakuman2(1);
    Sahatsakuman2 MB2 = new Sahatsakuman2(2);
    public int xx = hc.x;
    public int yy = hc.y;
    ...
    stage2(){
        ...
        addKeyListener(new KeyAdapter(){
            ...
            public void keyPressed(KeyEvent e){
                ...
                else if(a==KeyEvent.VK_DOWN){ ///////////////////////////////////////////////////พื้น + บันได
                    if(hc.floor==3){
                        if(Intersect(stairlong.getbound(),hc.getbound())){
                            if(hc.y>=475){
                                hc.y=475;
    ...
    public void paintComponent(Graphics g){
        ...
        g.drawImage(stairlong.stairlong.getImage(), stairlong.x - 120, stairlong.y,80 , 410, this); 
        g.drawImage(stair1.stair.getImage(), stair1.x , stair1.y, 80 , 200, this);
        g.drawImage(stair2.stair.getImage(), stair2.x + 70, stair2.y, 80 , 220, this); //mid
        ...
        if(checkbacktofront==0){           
            if(hc.count==0){
                if(checkattack == 1){
                    g.drawImage(hc.Htkf.getImage(), hc.x+16, hc.y, 120, 100, this);
                    g.drawString("Hanuman : "+hc.hp, hc.x, hc.y-15);
                    checkattack = 0;
                    ...
                    g.drawImage(hc.Hw.getImage(), hc.x, hc.y, 120, 100, this);
                    g.drawString("Hanuman : "+hc.hp, hc.x, hc.y-15);
                }            
            }
            else {
                g.drawImage(hc.Hwk.getImage(), hc.x, hc.y, 120, 100, this);
                g.drawString("Hanuman : "+hc.hp, hc.x, hc.y-15);
            }
            ...
            if(hc.count==0){
                if(checkattack == 1){
                    g.drawImage(hc.Htkb.getImage(), hc.x-41, hc.y, 120, 100, this);
                    g.drawString("Hanuman : "+hc.hp,hc.x, hc.y-15);
                    checkattack = 0;
                        if(MB1.hp<=0){
                            MB1.alive = false; 
                    ...
                    g.drawImage(hc.Hwb.getImage(), hc.x, hc.y, 120, 100, this);
                    g.drawString("Hanuman : "+hc.hp, hc.x, hc.y-15);
                }         
            }
            else{
                g.drawImage(hc.Hwbk.getImage(), hc.x, hc.y, 120, 100, this);
                g.drawString("Hanuman : "+hc.hp, hc.x, hc.y-15);
            }
        }
        if(MB1.count == 1){ 
            if(MB1.alive == true){
               ...
               g.drawString("SahatsaKuman : "+MB1.hp, MB1.x-10, MB1.y-15);
               MB1.count = 0;
               hit1 = true;
            }           
        }
        ...
        if(MB2.count == 1){ 
            if(MB2.alive == true){
               ...
               g.drawString("SahatsaKuman : "+MB2.hp, MB2.x-10, MB2.y-15);
               MB2.count = 0;
               hit2 = true;
            }           
        }
